  ...
  return (
    <section className="bg-white py-24 px-6">
      <div className="max-w-4xl mx-auto text-center">
        <div className="inline-flex items-center gap-2 bg-[#2563EB] bg-opacity-10 px-6 py-2 rounded-full mb-8">
          <Sparkles className="w-4 h-4 text-[#2563EB]" />
          <span className="text-[#2563EB] font-semibold">Built by Experts</span>
        </div>

        <h2 className="text-4xl lg:text-5xl font-bold text-[#1F2937] mb-8">
          Built by the Founder of Himana AI
        </h2>

        <p className="text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto mb-6">
          Himana AI was founded with a simple mission: to help real estate businesses leverage practical AI automation that actually works. Our team has years of experience in both real estate technology and artificial intelligence, allowing us to build solutions that understand the unique challenges agencies face.
        </p>
