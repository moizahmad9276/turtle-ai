        ...
        <div className="p-6 md:p-8 overflow-y-auto space-y-8 text-gray-300 text-sm md:text-base leading-relaxed">
          ...
          <section>
            ...
            <ul className="space-y-3 list-none">
              {["terms.s3.item1", "terms.s3.item2", "terms.s3.item3", "terms.s3.item4", "terms.s3.item5"].map((key, i) => (
          ...
          <section>
            ...
            <ul className="space-y-3 list-none">
              {["terms.s4.item1", "terms.s4.item2", "terms.s4.item3", "terms.s4.item4", "terms.s4.item5"].map((key, i) => (
                <li key={i} className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-[#2d9e6b] rounded-full mt-2 flex-shrink-0" />
                  {t(key)}
                </li>
