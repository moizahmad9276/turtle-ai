    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fade-in">
      ...
      <div className="relative w-full max-w-4xl max-h-[85vh] bg-[#0a1f14] border border-emerald-900 rounded-2xl flex flex-col shadow-2xl text-white overflow-hidden">
        ...
        <div className="p-6 md:p-8 overflow-y-auto space-y-8 text-gray-300 text-sm md:text-base leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mb-3">{t("privacy.s1.title")}</h2>
            <p>{t("privacy.s1.text")}</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-white mb-3">{t("privacy.s2.title")}</h2>
            <p className="mb-4">{t("privacy.s2.intro")}</p>
            <ul className="space-y-3 list-none">
              {["privacy.s2.item1","privacy.s2.item2","privacy.s2.item3","privacy.s2.item4","privacy.s2.item5"].map((key, i) => (
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mb-3">{t("privacy.s3.title")}</h2>
            <p className="mb-4">{t("privacy.s3.intro")}</p>
            <ul className="space-y-3 list-none">
              {["privacy.s3.item1","privacy.s3.item2","privacy.s3.item3","privacy.s3.item4","privacy.s3.item5","privacy.s3.item6","privacy.s3.item7"].map((key, i) => (
                <li key={i} className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-[#2d9e6b] rounded-full mt-2 flex-shrink-0" />
                  {t(key)}
                </li>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mb-3">{t("privacy.s4.title")}</h2>
            <p className="mb-4">{t("privacy.s4.intro")}</p>
            <ul className="space-y-3 list-none">
              {["privacy.s4.item1","privacy.s4.item2","privacy.s4.item3","privacy.s4.item4"].map((key, i) => (
                <li key={i} className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-[#2d9e6b] rounded-full mt-2 flex-shrink-0" />
                  {t(key)}
                </li>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mb-3">{t("privacy.s5.title")}</h2>
            <p>{t("privacy.s5.text")}</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-white mb-3">{t("privacy.s6.title")}</h2>
            <p>{t("privacy.s6.text")}</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-white mb-3">{t("privacy.s7.title")}</h2>
            <p className="mb-4">{t("privacy.s7.intro")}</p>
            <ul className="space-y-3 list-none">
              {["privacy.s7.item1","privacy.s7.item2","privacy.s7.item3","privacy.s7.item4","privacy.s7.item5","privacy.s7.item6","privacy.s7.item7"].map((key, i) => (
                <li key={i} className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-[#2d9e6b] rounded-full mt-2 flex-shrink-0" />
                  {t(key)}
                </li>
            ...
            <p className="mt-4">
              ...
              <a href="mailto:hello@turtleai.com" className="text-[#2d9e6b] hover:underline">hello@turtleai.com</a>.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-white mb-3">{t("privacy.s8.title")}</h2>
            <p>{t("privacy.s8.text")}</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-white mb-3">{t("privacy.s9.title")}</h2>
            <p>{t("privacy.s9.text")}</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-white mb-3">{t("privacy.s10.title")}</h2>
            <p>{t("privacy.s10.text")}</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-white mb-3">{t("privacy.s11.title")}</h2>
